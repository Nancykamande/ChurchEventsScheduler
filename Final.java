...
public class Final extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Edate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // date picker dialog
                datePickerDialog = new DatePickerDialog(Final.this,
        ...
        Estarttime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mTimePicker = new TimePickerDialog(Final.this,
    ...
    private void registerEvent() {
        ...
        mRef= FirebaseDatabase.getInstance().getReference("Final").child("fullname");
        Query query = mRef.orderByChild("date").equalTo(date);
        final  Query query1 = mRef.orderByChild("time").equalTo(time);
        final Query  query2 = mRef.orderByChild("Celebrant").equalTo(celebrant);
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(!snapshot.exists()){
                    //write your saving code
                    String FinalId=mRef.push().getKey();
                    Map<String,Object> map=new HashMap<>();
                    map.put( "time",Estarttime.getText().toString());
                    ...
                    mRef.child(FinalId).setValue(map)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Final.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Final.this, "Could Not Save", Toast.LENGTH_SHORT).show();
                                }
                            });
                            ...
                            if(!snapshot.exists()){
                                ...
                                query2.addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        }else { Toast.makeText(Final.this, "Celebrant already allocated", Toast.LENGTH_SHORT).show();}
